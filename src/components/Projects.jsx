...
const Projects = () => {
	...
	const projects = [
		...
		{
			title: 'Hello Sawari & Business X',
			description:
				'Developed two major platforms: Hello Sawari - a logistics platform for package delivery and vehicle rentals, and Business X - a comprehensive e-commerce solution.',
			image: '/hello-sawari.jpg',
			tech: ['Laravel', 'MySQL', 'Payment Gateway', 'RESTful API', 'SMS API'],
			featured: true,
			type: 'Professional',
			contribution: [
