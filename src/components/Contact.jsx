...
const Contact = () => {
  ...
  return (
    <section id="contact" className="py-32 bg-gradient-to-br from-slate-900/50 to-black/50 backdrop-blur-sm text-white">
          ...
          <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="animate-card group relative p-8 bg-white/5 rounded-xl backdrop-blur-sm hover:bg-white/10 transition-all duration-300">
              ...
              <div className="relative">
                ...
                <div className="mt-8">
                  <h3 className="text-xl font-semibold mb-6 text-blue-400">Social Links</h3>
            ...
            <form onSubmit={handleSubmit} className="animate-card group relative p-8 bg-white/5 rounded-xl backdrop-blur-sm hover:bg-white/10 transition-all duration-300">
              <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-300 rounded-xl bg-[radial-gradient(circle_at_var(--mouse-x)_var(--mouse-y),rgba(255,255,255,0.1),transparent_50%)]"></div>
